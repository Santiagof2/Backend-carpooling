...
from server.routes.rating_routes import ratings_bp

__all__ = ['passenger_trip_bp', 'vehicle_driver_bp', 'user_bp', 'driver_bp', 'trip_join_bp', 'trip_bp', 'address_bp', 'auth_bp', 'role_selection','vehicle_bp', 'passenger_bp', 'message_bp', 'trip_filter_bp', 'ratings_bp',]